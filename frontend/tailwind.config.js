...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      gradientColorStops: {
        'bizerte-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        'sea-gradient': 'linear-gradient(135deg, #667eea 0%, #14b8a6 100%)',
  ...
  plugins: [
    ...
    function({ addComponents }) {
      addComponents({
        ...
        '.btn-primary': {
          '@apply bg-bizerte-500 text-white hover:bg-bizerte-600 focus:ring-bizerte-500': {},
        },
        '.btn-secondary': {
        ...
        '.input': {
          '@apply w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-bizerte-500 focus:border-transparent': {},
        },
        '.label': {
